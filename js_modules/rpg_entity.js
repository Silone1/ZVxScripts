...
({
     ...
     entityUpdateStats: function (e)
     {
         ...
         e.physpower =  Math.log(x/3600 + 2) * this["1/ln(1.2)"] + x * this["1/3600*0.1"];
         
         e.magicpower = Math.log(x/3600 + 2) * this["1/ln(1.3)"] + x * this["1/3600*0.15"];
