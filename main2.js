/*  ///////////////////////// LEGAL NOTICE ///////////////////////////////
 ...
 /////////////////////// END LEGAL NOTICE /////////////////////////////// */
/**
 * @fileOverview This file is the main modloader, version two.
...
({
     ...
     activateModule: function (modname)
     {
         ...
         for (x in nfo.module.require)
         {
             ...
             if ( this.modInfo[reqmodname].state !== this.MODULE_LOADED )
             {
                 ...
                 this.modInfo[modname].state = this.MODULE_ERROR;
                 return; // error
             }
     ...
     loadScript: function  ()
     {
         ...
         if (sys.exists("ZVXSCRIPTS_COPYING"))
         {
         ...
         {
             print("~Script/WARNING~: Global object poisoned. Removing property: " + test2[x]);
     ...
     scriptinfo: function (msg, bt)
     {
         print ("~Module Loader~: " + msg);
     },
